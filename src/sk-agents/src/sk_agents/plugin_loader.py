...
class PluginLoader:
    def __init__(self, plugin_module: Union[str, None] = None):
    ...
    def set_plugin_module(self, plugin_module: Union[str, None]):
...
_plugin_loader: Union[PluginLoader, None] = None


def get_plugin_loader(plugin_module: Union[str, None] = None) -> PluginLoader:
