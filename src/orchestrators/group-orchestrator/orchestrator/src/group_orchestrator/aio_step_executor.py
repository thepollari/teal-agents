...
from group_orchestrator.agents.task_agent import PreRequisite
...
class AioStepExecutor:
    def __init__(self, task_agents: List[AioTaskAgent]):
        self.task_agents: Dict[str, AioTaskAgent] = {}
    ...
    async def _execute_task(
        ...
        pre_requisites: List[PreRequisite] = [
            AioStepExecutor._task_to_pre_requisite(self.task_accumulator[pre_requisite])
